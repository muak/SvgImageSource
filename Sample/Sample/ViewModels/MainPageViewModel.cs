            ...
            ChangeCommand.Subscribe(_ =>
            {
                switch(toggle){
                    case 0:
                        ...
                        break;
                    case 1:
                        Image.Value = SvgImageSource.FromResource("tiger.svg");
                        Image2.Value = SvgImageSource.FromResource("tiger.svg", 50, 50, Color.Red);
                        Image3.Value = SvgImageSource.FromStream(svgStream, 100, 100, Color.Blue);
                        Image4.Value = SvgImageSource.FromResource("ios-star.svg");
                        Image5.Value = SvgImageSource.FromResource("tiger.svg", 100, 50);
                        Image6.Value = SvgImageSource.FromResource("ios-star.svg");
                        Image7.Value = SvgImageSource.FromResource("ios-star.svg");
                        Image8.Value = SvgImageSource.FromUri("https://dl.dropbox.com/s/d2ijcomn07tfy56/adjust.svg", 120, 120, Color.Green);
                        Image9.Value = SvgImageSource.FromResource("ios-star.svg");
                        Image10.Value = SvgImageSource.FromStream(svgStream, 100, 100, Color.Blue);
                        toggle = -1;
                        break;
                    case 2:
